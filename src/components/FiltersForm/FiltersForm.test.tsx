...
describe('FiltersForm', () => {
  ...
  it('renders Apply and Reset buttons with translated text', () => {
    ...
    expect(screen.getByTestId('apply-filters-test')).toHaveTextContent('Apply Filters');
    expect(screen.getByTestId('reset-filters-test')).toHaveTextContent('Reset Filters');
  });
  ...
  it('clones children with formik props', () => {
    ...
    const ChildInput = (props: any) => <input data-testid="child-input" {...props} />;
