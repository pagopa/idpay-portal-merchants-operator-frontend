...
describe('BreadcrumbsBox', () => {
  ...
  it('chiama onClickBackButton se fornito', () => {
    ...
    render(
      <BrowserRouter>
        <BreadcrumbsBox backLabel="Indietro" items={items} active onClickBackButton={onClickMock} />
      </BrowserRouter>
    );
  ...
  it('chiama navigate con backButtonPath se onClickBackButton non fornito', () => {
    render(
      <BrowserRouter>
        <BreadcrumbsBox backLabel="Indietro" items={items} active backButtonPath="/test-path" />
      </BrowserRouter>
    );
