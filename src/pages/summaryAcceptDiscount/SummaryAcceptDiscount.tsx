              ...
              >
                <Grid container spacing={2}>
                  ...
                  >
                    ...
                    >
                      {t('pages.acceptDiscount.beneficiaryData')}
                    </Typography>
                    {summaryDataObj?.extendedAuthorization === false && (
                      <Chip
                        label="Identità verificata tramite IO"
                        size="small"
                        icon={<VerifiedIcon sx={{ color: '#0073E6 !important' }} />}
                      />
                    )}
                  </Grid>
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    ...
                    >
                      {t('pages.acceptDiscount.fiscalCode')}
                    </Typography>
                ...
                <Grid container spacing={2}>
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    <Typography
                      ...
                      sx={{ textTransform: 'uppercase' }}
                    >
                      {t('pages.acceptDiscount.discountCodeSummary')}
                    </Typography>
                  </Grid>
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    <Typography
                    ...
                    >
                      {t('pages.acceptDiscount.product')}
                    </Typography>
                    <Typography
                      variant="body2"
                  ...
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    ...
                    >
                      {t('pages.acceptDiscount.discountCode')}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{
                    ...
                    >
                      {summaryDataObj?.trxCode ?? MISSING_DATA_PLACEHOLDER}
                    </Typography>
                  </Grid>
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    <Typography
                    ...
                    >
                      {t('pages.acceptDiscount.emissionDate')}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: theme.typography.fontWeightMedium }}
                    >
                      {summaryDataObj
                        ? new Date(summaryDataObj?.trxDate).toLocaleDateString('it-IT')
                  ...
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    ...
                    >
                      {t('pages.acceptDiscount.amountToDiscount')}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: theme.typography.fontWeightMedium }}
                  ...
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    ...
                    >
                      {t('pages.acceptDiscount.discount')}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: theme.typography.fontWeightMedium }}
                  ...
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    ...
                    >
                      {t('pages.acceptDiscount.totalAmount')}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: theme.typography.fontWeightMedium }}
                  ...
                  <Grid size={{ xs: 12, md: 12, lg: 12 }}>
                    ...
                    >
                      {t('pages.acceptDiscount.status')}
                    </Typography>
                    <Chip
                      label={t('pages.acceptDiscount.toBeAuthorized')}
                      sx={{ marginTop: '10px' }}
                    />
                  </Grid>
                </Grid>
