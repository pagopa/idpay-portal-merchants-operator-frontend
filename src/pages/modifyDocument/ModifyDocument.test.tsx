...
describe('ModifyDocument component', () => {
  ...
  it('passes correct titleKey prop to FileUploadAction', () => {
    ...
    expect(screen.getByTestId('title-key')).toHaveTextContent('pages.modifyDocument.title');
  });
  ...
  it('passes correct i18nBlockKey prop', () => {
    ...
    expect(screen.getByTestId('i18n-block-key')).toHaveTextContent('pages.modifyDocument');
  });
  ...
  it('passes correct successStateKey prop', () => {
    ...
    expect(screen.getByTestId('success-state-key')).toHaveTextContent('refundUploadSuccess');
  });
  ...
  it('passes correct document number related props', () => {
    ...
    expect(screen.getByTestId('doc-number-title')).toHaveTextContent('Titolo Fattura');
    expect(screen.getByTestId('doc-number-insert')).toHaveTextContent('Inserisci Fattura');
    expect(screen.getByTestId('doc-number-label')).toHaveTextContent('Numero Fattura');
  });
